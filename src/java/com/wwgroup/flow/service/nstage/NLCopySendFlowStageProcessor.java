...
public class NLCopySendFlowStageProcessor extends NLAbstractFlowStageProcessor {
	...
	boolean startNextValidate(Flow flow) {
		//logger.info(flow.getFormNum() + " 状态：" + flow.getStatus() + " startNextValidate: " + NLCopySendFlowStageProcessor.class.getName());
	...
	boolean completeValidate(Flow flow) {
		//logger.info(flow.getFormNum() + " 状态：" + flow.getStatus() + " completeValidate: " + NLCopySendFlowStageProcessor.class.getName());
		return flow.getStatus() == FlowStatus.CC_End;
	}
